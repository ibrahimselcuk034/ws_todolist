...
function addItem(e) {
  if (e.key === 'Enter' || e.type === 'click') {
    if (inputBox.value.trim() === "") {
      ...
      // cancelBtn.className = 'cancel_btn btn-grup-save badge badge-warning ';
      ...
      addedDate.innerHTML = 'Added on: ' + liveDate1.getDate() + "." + liveMonth + "."+ liveDate1.getFullYear() + " - " + liveDate1.getHours() + ":" + liveDate1.getMinutes() + ":" + liveDate1.getSeconds();
...
const saveItem = function(e) {
  ...
  editedDate.innerHTML = 'Edited on: ' + liveDate2.getDate() + "." + liveMonth + "."+ liveDate2.getFullYear() + " - " + liveDate2.getHours() + ":" + liveDate2.getMinutes() + ":" + liveDate2.getSeconds();
